...
const ThemeToggle = () => {
  ...
  return (
    ...
    >
      <div className="flex w-12 h-6 items-center justify-between px-1">
        {/* Sun icon */}
        ...
        {/* Moon icon */}
        <svg className="w-4 h-4 text-gray-500 dark:text-blue-200" fill="currentColor" viewBox="0 0 20 20">
